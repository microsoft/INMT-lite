...
ENCODER_MAX_LEN = 36
DECODER_MAX_LEN = 36
ENTIRE_MODEL_SAVE_PATH = "/home/t-hdiddee/INMT-Tflite/models/Hm/mt5_small_en_gu/"
ENCODER_TFLITE_PATH =  f"/home/t-hdiddee/INMT-Tflite/en_gu_36_encoder.tflite"
DECODER_TFLITE_PATH = f"/home/t-hdiddee/INMT-Tflite/en_gu_36_decoder.tflite"
# MODEL_PATH = '/home/t-hdiddee/INMT-Tflite/transformer/scripts/main/mt5_en_hi/checkpoint-3900/spiece.model'
...
def getCustomDecoder(layer, config):
    ...
    # decoder_attention_mask = tf.keras.layers.Input(shape=(DECODER_MAX_LEN, ), dtype = tf.int32) # (1,DECODER_MAX_LEN)
...
if __name__=='__main__':
    ...
    # decoder_outputs = decoder(tf.convert_to_tensor(decoder_input_ids),encoder_hidden_states=encoder_outputs)
    # lm_logits = lm_head(decoder_outputs[0])
    # next_decoder_input_ids = tf.keras.layers.Add()([decoder_input_ids, decoder_input_ids])
    
    # decoder_outputs = decoder(tf.convert_to_tensor(next_decoder_input_ids),encoder_hidden_states=encoder_outputs)
    # lm_logits = lm_head(decoder_outputs[0])
    # next_decoder_input_ids = tf.keras.layers.Add()([decoder_input_ids, decoder_input_ids])
